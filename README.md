...
```sh
$ git clone https://github.com/luk0y/Telegram_VC_Bot
$ cd Telegram_VC_Bot
...
Download this file [generate_string_session.py](https://raw.githubusercontent.com/luk0y/Telegram_VC_Bot/master/generate_string_session.py)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/luk0y/Telegram_VC_Bot/tree/master)


Send [commands](https://github.com/luk0y/Telegram_VC_Bot/blob/master/README.md#commands) to bot to 
play music.
...
```sh
$ git clone https://github.com/luk0y/Telegram_VC_Bot && cd Telegram_VC_Bot
$ cp sample.env .env
```
...
1. If you want any help you can ask [here](https://t.me/admin)
